...
/**
 ...
 @garderNote: obviously we would never store a card number in a way like this, but we have not covered any good way to do this and this is a mock function anyways.
*/
